...
type
  TDataModule1 = class(TDataModule)
    ...
    ZQueryPenangananid_penanganan: TIntegerField;
    ZQueryPenanganannama_perangkat: TWideStringField;
    ZQueryPenanganantanggal_kerusakan: TDateTimeField;
    ZQueryPenanganankerusakan: TWideMemoField;
    ZQueryPenanganantanggal_penanganan: TDateTimeField;
    ZQueryPenangananteknisi: TWideStringField;
    ZQueryPenanganancreated_at: TDateTimeField;
    ZQueryPenangananupdated_at: TDateTimeField;
    procedure ZQueryLogaktivitasGetText(Sender: TField; var Text: string;
      DisplayText: Boolean);
    procedure ZQueryPenanganankerusakanGetText(Sender: TField; var Text: string;
      DisplayText: Boolean);
  private
...
procedure TDataModule1.ZQueryPenanganankerusakanGetText(Sender: TField;
  var Text: string; DisplayText: Boolean);
begin
  Text := Copy( DataModule1.ZQueryPenanganan.FieldByName('kerusakan').AsString, 1, 200);
end;
